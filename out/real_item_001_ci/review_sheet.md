...
## Lineage
- item_blueprint / attempt 1 / status `succeeded` / output `art-3d0cb6c6e612`
- draft_item / attempt 1 / status `succeeded` / output `art-88678e6d818a`
- solve / attempt 1 / status `succeeded` / output `art-f31b6b281c4a`
- critique / attempt 1 / status `succeeded` / output `art-b631690ebfba`
- revise / attempt 1 / status `succeeded` / output `art-dac0b3d9f52c`
- validate / attempt 1 / status `succeeded` / output `art-832b907dec2b`
